...
private:
    ...
    bool SeedWarmStartFromCache(std::uint64_t pair_key,
        ...
        c.tangent1_lambda = cached.points[best_index].tangent1_lambda * warm_start_ratio;
        c.tangent2_lambda = cached.points[best_index].tangent2_lambda * warm_start_ratio;
